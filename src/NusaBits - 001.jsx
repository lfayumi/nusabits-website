  ...
  return (
    <div className={`${isDarkMode ? 'dark' : ''} min-h-screen font-sans scroll-smooth`}>
      <div className="bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-200 transition-colors duration-300 overflow-hidden">
        ...
        {/* --- NAVIGATION --- */}
        <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white/80 dark:bg-slate-900/80 backdrop-blur-md shadow-sm py-3' : 'bg-transparent py-5'}`}>
          ...
          {mobileMenuOpen && (
            <div className="lg:hidden absolute top-full left-0 w-full bg-white dark:bg-slate-900 shadow-lg border-t border-slate-100 dark:border-slate-800 py-4 flex flex-col items-center gap-4">
              {navLinks.map((link) => (
                <button 
                  key={link.id} 
                  onClick={() => scrollTo(link.id)}
                  className="w-full text-center py-2 hover:text-blue-600 dark:hover:text-blue-400 font-medium"
                >
                  {link.name}
                </button>
              ))}
        ...
        <section id="home" className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
          ...
          <div className="absolute top-0 right-0 -translate-y-12 translate-x-1/3 w-96 h-96 bg-blue-400/20 dark:bg-blue-600/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-0 translate-y-1/3 -translate-x-1/3 w-[500px] h-[500px] bg-indigo-400/20 dark:bg-indigo-600/10 rounded-full blur-3xl"></div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16">
              ...
              <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
                ...
                <Reveal direction="up" delay={200}>
                  <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight tracking-tight text-slate-900 dark:text-white mb-6">
                ...
                <Reveal direction="up" delay={400}>
                  <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                    <button onClick={() => scrollTo('contact')} className="px-8 py-4 rounded-full bg-blue-600 text-white font-medium hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/30 hover:shadow-blue-600/50 flex items-center justify-center gap-2 group">
                      Start Your Project
                      <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
                    </button>
                    <button onClick={() => scrollTo('portfolio')} className="px-8 py-4 rounded-full bg-white dark:bg-slate-800 text-slate-900 dark:text-white font-medium border border-slate-200 dark:border-slate-700 hover:border-blue-600 dark:hover:border-blue-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all flex items-center justify-center gap-2">
                      View Portfolio
                    </button>
                  </div>
                </Reveal>
              ...
              {/* Hero Illustration (Abstract/UI Composition) */}
              <div className="w-full lg:w-1/2 relative h-[400px] sm:h-[500px]">
                <Reveal direction="left" delay={300}>
                  <div className="relative w-full h-full perspective-1000">
                    {/* Main Mockup Window */}
                    <div className="absolute inset-0 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-800 overflow-hidden transform rotate-y-[-10deg] rotate-x-[5deg] transition-transform duration-700 hover:rotate-y-0 hover:rotate-x-0">
                      {/* Window Header */}
                      ...
                      {/* Window Body Mockup */}
                      <div className="p-6 h-full bg-slate-50 dark:bg-slate-950 flex flex-col gap-4">
                        <div className="w-1/3 h-6 bg-slate-200 dark:bg-slate-800 rounded animate-pulse"></div>
                        <div className="flex gap-4 mb-4">
                          <div className="w-1/2 h-32 bg-blue-100 dark:bg-blue-900/30 rounded-xl border border-blue-200 dark:border-blue-800"></div>
                          <div className="w-1/2 h-32 bg-indigo-100 dark:bg-indigo-900/30 rounded-xl border border-indigo-200 dark:border-indigo-800"></div>
                        </div>
        ...
        <section id="blog" className="py-24 bg-slate-50 dark:bg-slate-950">
          <div className="container mx-auto px-6 md:px-12">
            <Reveal direction="up">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                <div className="max-w-2xl">
                  <div className="text-blue-600 dark:text-blue-400 font-bold tracking-wider uppercase text-sm mb-2">Insights</div>
                  <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white">
                    Latest Tech & Business News
                  </h2>
                </div>
                <button className="text-blue-600 dark:text-blue-400 font-semibold hover:underline flex items-center gap-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { title: 'The Future of AI in Enterprise Software', category: 'Technology Trends', date: 'Oct 12, 2026', img: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&w=600&q=80' },
                { title: 'Why Next.js is Perfect for Large Scale Apps', category: 'Software Development', date: 'Sep 28, 2026', img: 'https://images.unsplash.com/photo-1618477247222-ac60c6470d03?auto=format&fit=crop&w=600&q=80' },
                { title: 'Designing for Gen-Z: Micro-interactions', category: 'UI/UX Insights', date: 'Sep 15, 2026', img: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?auto=format&fit=crop&w=600&q=80' }
              ].map((post, idx) => (
                <Reveal key={idx} direction="up" delay={idx * 100}>
                  <div className="group cursor-pointer">
                    <div className="overflow-hidden rounded-2xl mb-4 aspect-[16/10]">
                  ...
                  <div className="space-y-6 mb-10">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 dark:text-slate-400 text-sm">Sudirman Central Business District (SCBD)<br/>Jakarta Selatan, Indonesia 12190</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-full bg-blue-50 dark:bg-slate-800 flex items-center justify-center text-blue-600 dark:text-blue-400 shrink-0">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 dark:text-slate-400 text-sm">hello@nusabits.co.id</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-full bg-blue-50 dark:bg-slate-800 flex items-center justify-center text-blue-600 dark:text-blue-400 shrink-0">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 dark:text-slate-400 text-sm">+62 811 2345 6789</p>
                      </div>
                    </div>
                  </div>
