                ...
                <section id="home" className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden mt-16 lg:mt-0">
                    ...
                    <div className="container mx-auto px-6 md:px-12 relative z-10">
                        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                            ...
                            <div className="hidden lg:block lg:w-1/2 relative h-[400px] sm:h-[500px]">
                                <Reveal direction="left" delay={300}>
                                    <div className="relative w-full h-full perspective-1000 flex justify-end items-center">
                                        {/* Mockup Box */}
                                        <div className="w-5/6 h-5/6 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md rounded-2xl shadow-2xl border border-white/20 dark:border-slate-700/50 overflow-hidden transform rotate-y-[-15deg] rotate-x-[5deg] transition-transform duration-700 hover:rotate-y-0 hover:rotate-x-0 flex flex-col">

                                            {/* Window Header */}
                                            <div className="h-8 bg-slate-100 dark:bg-slate-800 flex items-center px-4 gap-2 border-b border-slate-200 dark:border-slate-700 shrink-0">
                                                <div className="w-3 h-3 rounded-full bg-red-400 shadow-sm"></div>
                                                <div className="w-3 h-3 rounded-full bg-yellow-400 shadow-sm"></div>
                                                <div className="w-3 h-3 rounded-full bg-green-400 shadow-sm"></div>
                                            </div>

                                            {/* Window Body - Professional Dashboard UI */}
                                            <div className="p-5 h-full flex flex-col gap-4 overflow-hidden">

                                                {/* Header Section */}
                                                <div className="flex justify-between items-center mb-1">
                                                    <h3 className="font-bold text-slate-800 dark:text-white text-lg">Analytics Overview</h3>
                                                    <span className="px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs font-semibold rounded-md border border-blue-200 dark:border-blue-800/50">
                                                        This Week
                                                    </span>
                                                </div>
                                                ...
                                                <div className="flex gap-4">
                                                    <div className="flex-1 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-700/50 hover:border-blue-300 dark:hover:border-blue-700 transition-colors">
                                                        <p className="text-xs text-slate-500 dark:text-slate-400 mb-1 font-medium">Total Revenue</p>
                                                        <p className="text-xl font-bold text-slate-900 dark:text-white">$84,500</p>
                                                        <p className="text-xs text-emerald-500 font-semibold mt-1 flex items-center gap-1">↑ 12.5%</p>
                                                    </div>
                                                    <div className="flex-1 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-700/50 hover:border-blue-300 dark:hover:border-blue-700 transition-colors">
                                                        <p className="text-xs text-slate-500 dark:text-slate-400 mb-1 font-medium">Active Users</p>
                                                        <p className="text-xl font-bold text-slate-900 dark:text-white">12,450</p>
                                                        <p className="text-xs text-emerald-500 font-semibold mt-1 flex items-center gap-1">↑ 8.2%</p>
                                                    </div>
                                                </div>

                                                {/* Chart Area (Simulated Bar Chart using Tailwind) */}
                                                <div className="flex-1 mt-1 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-700/50 p-4 flex flex-col justify-end gap-2 group cursor-pointer">
                                                    <div className="flex items-end justify-between h-16 sm:h-20 gap-2 w-full">
                                                        <div className="w-full bg-blue-200 dark:bg-blue-900/50 rounded-t-sm h-[40%] group-hover:bg-blue-300 dark:group-hover:bg-blue-800/50 transition-colors"></div>
                                                        <div className="w-full bg-blue-300 dark:bg-blue-800/60 rounded-t-sm h-[60%] group-hover:bg-blue-400 dark:group-hover:bg-blue-700/60 transition-colors"></div>
                                                        <div className="w-full bg-blue-400 dark:bg-blue-700/70 rounded-t-sm h-[45%] group-hover:bg-blue-500 dark:group-hover:bg-blue-600/70 transition-colors"></div>
                                                        <div className="w-full bg-blue-500 dark:bg-blue-600/80 rounded-t-sm h-[80%] group-hover:bg-blue-600 dark:group-hover:bg-blue-500/80 transition-colors"></div>
                                                        <div className="w-full bg-blue-600 dark:bg-blue-500 rounded-t-sm h-[100%] relative">
                                                            {/* Tooltip for highest bar */}
                                                            <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-slate-800 dark:bg-white text-white dark:text-slate-900 text-[10px] px-2 py-1 rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                                                                Peak: $24k
                                                            </div>
                                                        </div>
                                                        <div className="w-full bg-blue-400 dark:bg-blue-700/70 rounded-t-sm h-[65%] group-hover:bg-blue-500 dark:group-hover:bg-blue-600/70 transition-colors"></div>
                                                        <div className="w-full bg-blue-300 dark:bg-blue-800/60 rounded-t-sm h-[50%] group-hover:bg-blue-400 dark:group-hover:bg-blue-700/60 transition-colors"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="mt-2 space-y-3">
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-8 h-8 rounded-full bg-indigo-100 dark:bg-indigo-900/50 flex items-center justify-center text-indigo-700 dark:text-indigo-300 font-bold text-xs shrink-0">JD</div>
                                                        <div className="flex-1">
                                                            <p className="text-sm font-semibold text-slate-800 dark:text-slate-200 leading-tight">John Doe signed up</p>
                                                            <p className="text-[10px] text-slate-500 dark:text-slate-400">2 minutes ago</p>
                                                        </div>
                                                    </div>
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-8 h-8 rounded-full bg-emerald-100 dark:bg-emerald-900/50 flex items-center justify-center text-emerald-700 dark:text-emerald-300 font-bold text-xs shrink-0">AS</div>
                                                        <div className="flex-1">
                                                            <p className="text-sm font-semibold text-slate-800 dark:text-slate-200 leading-tight">System update complete</p>
                                                            <p className="text-[10px] text-slate-500 dark:text-slate-400">1 hour ago</p>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div>
                                <Reveal direction="left">
                                    <div className="bg-white dark:bg-slate-950 p-8 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-800">
                                        ...
                                        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); alert("Form submitted successfully! (Simulation)"); }}>
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <textarea required rows="4" className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all text-slate-900 dark:text-white resize-none" placeholder="Tell us about your requirements..."></textarea>
                                            </div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-4 text-sm">
                                    <li className="flex items-center gap-3">
                                        <Mail size={16} className="text-blue-500" /> hello@nusabits.co.id
                                    </li>
                                    <li className="flex items-center gap-3">
                                        <Phone size={16} className="text-blue-500" /> +62 811 2345 6789
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <MapPin size={16} className="text-blue-500 shrink-0 mt-1" />
                                        <span>SCBD, Jakarta Selatan<br />Indonesia 12190</span>
                                    </li>
                                </ul>
                            </div>
