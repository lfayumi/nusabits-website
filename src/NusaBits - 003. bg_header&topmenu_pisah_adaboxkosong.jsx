                            ...
                            <div className="hidden lg:block lg:w-1/2 relative h-[400px] sm:h-[500px]">
                                <Reveal direction="left" delay={300}>
                                    <div className="relative w-full h-full perspective-1000 flex justify-end items-center">
                                        {/* Mockup Box - Dibuat lebih kecil agar tidak menutupi gambar background profesional */}
                                        <div className="w-5/6 h-5/6 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md rounded-2xl shadow-2xl border border-white/20 dark:border-slate-700/50 overflow-hidden transform rotate-y-[-15deg] rotate-x-[5deg] transition-transform duration-700 hover:rotate-y-0 hover:rotate-x-0">
                                            ...
                                            <div className="p-6 h-full flex flex-col gap-4">
                                                ...
                                                <div className="flex gap-4 mb-4">
                                                    <div className="w-1/2 h-24 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-100 dark:border-blue-800/50"></div>
                                                    <div className="w-1/2 h-24 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl border border-indigo-100 dark:border-indigo-800/50"></div>
                                                </div>
